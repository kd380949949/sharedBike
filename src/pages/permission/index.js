...
export default class Order extends React.Component{
    constructor(props){
        ...
        this.state={
            list:'',//请求回来的role/list
            isRoleVisible:false,//创建用户flag
            isPermVisible:false,//权限设置flag
            isUserVisible:false,//用户授权flag
            detailInfo:'',//当前选中行的信息 selectedItem
            menuInfo:'',//当前选中行的menu信息
            targetKeys:'',//选中的权限
    ...
    handlePermission=()=>{ //设置权限按钮
        ...
        let menuList = this.state.selectedItem.menus;//当前行的menu项
        this.setState({
            menuInfo:menuList
        })
    }
    ...
    handleUserSubmit = ()=>{
        let data = {};
        data.user_ids = this.state.targetKeys || [];//选中的权限
        data.role_id = this.state.selectedItem.id;//点击的当前行的id
        axios.ajax({
